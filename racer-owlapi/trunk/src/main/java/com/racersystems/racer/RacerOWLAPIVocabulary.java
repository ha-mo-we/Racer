...
public class RacerOWLAPIVocabulary extends RacerKRSSVocabulary {
    ...
    public static final String OWLAPI_GET_DISJOINT_CLASSES = "OWLAPI-getDisjointClasses";
    public static final String OWLAPI_GET_DISJOINT_OBJECTPROPERTIES = "OWLAPI-getDisjointObjectProperties";
    public static final String OWLAPI_GET_DISJOINT_DATAPROPERTIES = "OWLAPI-getDisjointDataProperties";

    public static final String OWLAPI_GET_DESCENDANT_PROPERTIES = "OWLAPI-getDescendantProperties";
    public static final String OWLAPI_GET_DIFFERENT_INDIVIDUALS = "OWLAPI-getDifferentIndividuals";
    ...
    public static final String OWLAPI_AUTOBATCHADDAXIOMSTO="OWLAPI-autoBatchAddAxiomsTo";
    ...
    public static final String DFILLER="d-filler";


    public static final String OWLAPI_ISCONSISTENT="OWLAPI-isConsistent";

    public static final String OWLAPI_ISENTAILED = "owlapi-is-entailed";
    ...
    public static final String OWLAPI_ABORT = "OWLAPI-abortRequest";
    public static final String OWLAPI_GET_PROGRESS = "OWLAPI-getProgress";
    public static final String OWLAPI_SET_PROGRESSRANGE="OWLAPI-setProgressRange";
    ...
    public static final String OWLAPI_CREATE_ATTRIBUTE = ":create";

    public static final String OWLAPI_ENABLE_MEMORYSAVING_MODE = "OWLAPI-enableMemorySavingMode";
