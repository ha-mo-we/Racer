...
public abstract class AbstractReasonerOntologyCase extends TestCase {
    ...
    /**
     * Returns the BufferingMode to be used for the Reasoner.
     * <blockquote>
     * Note that the BufferingMode will be set during {@link #setUp()}
     * </blockquote>
     *
     * @return BufferingMode to be set for the Reasoner
     */
    ...
    protected Configuration getConfiguration() {
        return new Configuration(new InetSocketAddress("localhost",8088));
    }
