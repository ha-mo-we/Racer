...
public class testRacer {
    ...
    public static void main(String[] args) throws Exception {
        InetSocketAddress address = new InetSocketAddress("134.60.75.180", 8088);
      //  while (true) {
           ...
           // out.println("(OWLAPI-getProgress r1)");
            out.println("(owlapi-is-entailed (OWLAPI-getOWLSubClassAxiom test#B test#A))");
            out.flush();
        readFromSocket(racerSocket.getInputStream());
